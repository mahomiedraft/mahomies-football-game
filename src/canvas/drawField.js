export function drawStadium(ctx, canvas, options = {}) {
  ...
  drawEndZone(ctx, fieldX + fieldW - endZoneW, fieldY, endZoneW, fieldH, npcColors.primary, npcTeamName);
...
function drawCrowd(ctx, x, y, w, h) {
  // Deterministic-ish dots (no Math.random spam per refresh? but fine for now)
